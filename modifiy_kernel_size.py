...
configs_folder = f'models/config/blur/rtmpose-m_8xb64-210e_mpii-256x256.'
config = 'rtmpose-m_8xb64-210e_mpii-256x256.py'

kernel_value = [5, 5]

for _ in range(30):
    output_path = f'{configs_folder}/rtmpose-m_8xb64-210e_mpii-256x256_{kernel_value[0]}x{kernel_value[1]}.py'
